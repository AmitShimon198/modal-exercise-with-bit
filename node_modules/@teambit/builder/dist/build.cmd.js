...
class BuilderCmd {
  constructor(builder, workspace, logger) {
    ...
    (0, _defineProperty2().default)(this, "options", [['', 'install', 'install core aspects in capsules'], ['', 'reuse-capsules', 'avoid deleting the capsules root-dir before starting the build'], ['', 'tasks <string>', `build the specified task(s) only. for multiple tasks, separate by a comma and wrap with quotes.
