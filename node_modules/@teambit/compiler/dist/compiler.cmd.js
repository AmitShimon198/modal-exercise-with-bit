...
class CompileCmd {
  constructor(compile, logger, pubsub) {
    ...
    (0, _defineProperty2().default)(this, "description", 'compile components in the development workspace');
    (0, _defineProperty2().default)(this, "alias", '');
    (0, _defineProperty2().default)(this, "group", 'development');
    (0, _defineProperty2().default)(this, "options", [['c', 'changed', 'compile only new and modified components'], ['v', 'verbose', 'show more data, such as, dist paths'], ['j', 'json', 'return the compile results in json format']]);
  }
  ...
  async json([components], compilerOptions) {
    compilerOptions.deleteDistDir = true; // @ts-ignore
