...
class ComponentMain {
  ...
  static async provider([graphql, express, cli, configAspect], config, [hostSlot, showFragmentSlot]) {
...
(0, _defineProperty2().default)(ComponentMain, "dependencies", [_graphql().GraphqlAspect, _express().ExpressAspect, _cli().CLIAspect, _config().ConfigAspect]);
