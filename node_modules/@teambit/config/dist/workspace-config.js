...
class WorkspaceConfig {
  constructor(data, legacyConfig) {
    ...
    this.isLegacy = Boolean((0, _featureToggle().isLegacyEnabled)() || legacyConfig);
    ...
    if (isHarmony) {
      ...
      this._extensions = _config().ExtensionDataList.fromConfigObject(transformLegacyPropsToExtensions(legacyConfig));
  ...
  static async create(props, dirPath, legacyInitProps) {
    if ((0, _featureToggle().isLegacyEnabled)() && dirPath) {
      ...
      const legacyConfig = await _workspaceConfig().default._ensure(dirPath, standAlone, legacyProps);
      const instance = WorkspaceConfig.fromLegacyConfig(legacyConfig);
      return instance;
    }

    const template = await getWorkspaceConfigTemplateParsed(); // TODO: replace this assign with some kind of deepAssign that keeps the comments
  ...
  static async ensure(dirPath, workspaceConfigProps = {}, legacyInitProps) {
    try {
  ...
  static async reset(dirPath, resetHard) {
    ...
    if (resetHard) {
      ...
      await _workspaceConfig().default.reset(dirPath, true);
  ...
  toLegacy() {
    var _this$extension, _this$legacyConfig6, _this$extension2, _this$extension3, _this$extension4, _this$extension5, _this$_legacyProps, _this$_legacyProps2, _this$_legacyProps3, _this$_legacyProps4, _this$_legacyProps5, _this$extension6, _this$extension7, _this$legacyConfig7, _this$legacyConfig8, _this$legacyConfig9, _this$legacyConfig10, _this$legacyConfig11, _this$legacyConfig12;
    ...
    const _getEnvsByType = type => {
      var _this$legacyConfig5;

      if (type === _constants().COMPILER_ENV_TYPE) {
        var _this$legacyConfig4;

        return (_this$legacyConfig4 = this.legacyConfig) === null || _this$legacyConfig4 === void 0 ? void 0 : _this$legacyConfig4.compiler;
      }

      return (_this$legacyConfig5 = this.legacyConfig) === null || _this$legacyConfig5 === void 0 ? void 0 : _this$legacyConfig5.tester;
    };
    ...
    return {
      lang: ((_this$legacyConfig6 = this.legacyConfig) === null || _this$legacyConfig6 === void 0 ? void 0 : _this$legacyConfig6.lang) || _constants().DEFAULT_LANGUAGE,
      ...
      componentsConfig: this.legacyConfig ? (_this$legacyConfig7 = this.legacyConfig) === null || _this$legacyConfig7 === void 0 ? void 0 : _this$legacyConfig7.overrides : undefined,
      getComponentConfig: this.legacyConfig ? (_this$legacyConfig8 = this.legacyConfig) === null || _this$legacyConfig8 === void 0 ? void 0 : _this$legacyConfig8.overrides.getOverrideComponentData.bind((_this$legacyConfig9 = this.legacyConfig) === null || _this$legacyConfig9 === void 0 ? void 0 : _this$legacyConfig9.overrides) : () => undefined,
      _legacyPlainObject: this.legacyConfig ? (_this$legacyConfig10 = this.legacyConfig) === null || _this$legacyConfig10 === void 0 ? void 0 : _this$legacyConfig10.toPlainObject.bind(this.legacyConfig) : () => undefined,
      _compiler: (_this$legacyConfig11 = this.legacyConfig) === null || _this$legacyConfig11 === void 0 ? void 0 : _this$legacyConfig11.compiler,
      _setCompiler,
      _tester: (_this$legacyConfig12 = this.legacyConfig) === null || _this$legacyConfig12 === void 0 ? void 0 : _this$legacyConfig12.tester,
      _setTester
    };
  }
