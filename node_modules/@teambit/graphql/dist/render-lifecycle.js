...
exports.GraphqlRenderLifecycle = void 0;
...
class GraphqlRenderLifecycle {
  constructor(graphqlUI) {
    ...
    (0, _defineProperty2().default)(this, "serverInit", ({
      ...
      const port = (server === null || server === void 0 ? void 0 : server.port) || 3000;
      const serverUrl = `http://localhost:${port}/graphql`;
      const client = this.graphqlUI.createSsrClient({
        serverUrl,
        headers: (0, _lodash().default)(browser.connection.headers, ALLOWED_HEADERS)
      });
      const ctx = {
        client
      };
    ...
    (0, _defineProperty2().default)(this, "onBeforeRender", async (ctx, app) => {
      await (0, _ssr().getDataFromTree)(app);
    });
...
exports.GraphqlRenderLifecycle = GraphqlRenderLifecycle;
