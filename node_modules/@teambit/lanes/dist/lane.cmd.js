...
exports.LaneCmd = exports.LaneRemoveCmd = exports.LaneMergeCmd = exports.LaneTrackCmd = exports.LaneCreateCmd = exports.LaneShowCmd = exports.LaneListCmd = void 0;
...
function _mergeCmd() {
  const data = require("@teambit/legacy/dist/cli/commands/public-cmds/merge-cmd");
...
class LaneCreateCmd {
  ...
  async report([name], createLaneOptions) {
    ...
    const title = _chalk().default.green(`successfully added a new lane ${_chalk().default.bold(result.localLane)}`);
...
class LaneMergeCmd {
  ...
  async report([name], {
    ...
    return (0, _mergeCmd().mergeReport)(results);
  }
...
class LaneRemoveCmd {
  ...
  async report([names], {
    ...
    if (!silent) {
      const removePromptResult = await (0, _prompts().removePrompt)(); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
...
https://${_constants().BASE_DOCS_DOMAIN}/docs/lanes`);
    (0, _defineProperty2().default)(this, "alias", '');
    (0, _defineProperty2().default)(this, "options", [['d', 'details', 'show more details on the state of each component in each lane'], ['j', 'json', 'show lanes details in json format'], ['r', 'remote <string>', 'show remote lanes'], ['', 'merged', 'show merged lanes'], ['', 'not-merged', 'show not merged lanes']]);
    (0, _defineProperty2().default)(this, "loader", true);
    (0, _defineProperty2().default)(this, "private", true);
