...
class Analytics {
  ...
  static promptAnalyticsIfNeeded() {
    ...
    function shouldPromptForAnalytics() {
      ...
      if (cmd.length && cmd[0] !== 'config' && !process.env.CI) {
        ...
        return (0, _isNil2().default)(analyticsReporting) && (0, _isNil2().default)(errorReporting);
      }
  ...
  static _hashFlags(flags) {
    const hashedFlags = {};
    const definedFlags = (0, _filter2().default)(flag => typeof flag !== 'undefined', flags);

    if (this.anonymous && !(0, _isEmpty2().default)(definedFlags)) {
