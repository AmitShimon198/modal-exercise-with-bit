...
Object.defineProperty(exports, "registerDefaultScopeGetter", {
  enumerable: true,
  get: function () {
    return _export().registerDefaultScopeGetter;
  }
});
...
Object.defineProperty(exports, "snapAction", {
  enumerable: true,
  get: function () {
    return _snap().snapAction;
  }
});
...
Object.defineProperty(exports, "switchAction", {
  enumerable: true,
  get: function () {
...
function _export() {
  const data = _interopRequireWildcard(require("./lib/export"));
...
function _switch() {
  const data = _interopRequireDefault(require("./lib/switch"));
...
function _clearCache() {
  const data = require("./lib/clear-cache");
