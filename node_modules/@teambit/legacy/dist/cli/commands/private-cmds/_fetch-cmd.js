...
class Fetch {
  ...
  report(objectList) {
    const objectListStr = objectList.toJsonString(); // No need to use packCommand because we handle all the base64 stuff in a better way inside the ComponentObjects.manyToString
