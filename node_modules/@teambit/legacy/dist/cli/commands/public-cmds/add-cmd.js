...
class Add {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'Add any subset of files to be tracked as a component(s).');
  ...
  action([paths = []], {
    ...
    if (!(0, _isEmpty2().default)(tests) && !id && (0, _isEmpty2().default)(normalizedPaths)) {
