...
class Build {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'build any set of components with configured compiler (component compiler or as defined in bit.json)');
    ...
    (0, _defineProperty2().default)(this, "opts", [['v', 'verbose', 'showing npm verbose output for inspection'], ['c', 'no-cache', 'ignore component cache when creating dist file']]);
