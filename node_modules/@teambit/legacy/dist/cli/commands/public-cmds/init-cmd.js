...
class Init {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'create or reinitialize an empty Bit scope or reinitialize an existing one');
    ...
    ['d', 'default-directory <default-directory>', 'set up default directory to import components into'], ['p', 'package-manager <package-manager>', 'set up package manager (npm or yarn)'], ['f', 'force', 'force workspace initialization without clearing local objects'], ['', 'harmony', 'DEPRECATED. no need for this flag. Harmony is the default now'], ['I', 'interactive', 'EXPERIMENTAL. start an interactive process']]);
  }
  ...
  action([path], flags) {
    ...
    return (0, _consumer().init)(path, standalone, reset, resetNew, resetHard, force, workspaceConfigFileProps).then(({
      created,
      addedGitHooks,
      existingGitHooks
    }) => {
