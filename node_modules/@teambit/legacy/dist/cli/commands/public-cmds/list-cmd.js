...
class List {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'list components on a workspace, local scope or a remote scope.');
  ...
  report({
    ...
    if ((0, _isEmpty2().default)(listScopeResults)) {
