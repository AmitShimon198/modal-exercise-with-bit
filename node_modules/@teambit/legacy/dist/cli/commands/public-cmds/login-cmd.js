...
class Login {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "opts", [['p', 'port <port>', 'port number to open for localhost server (default 8085)'], ['', 'suppress-browser-launch', 'do not open a browser for authentication'], ['', 'npmrc-path <path>', `path to npmrc file to configure ${_constants().BASE_WEB_DOMAIN} registry`], ['', 'skip-registry-config', `don't configure ${_constants().BASE_WEB_DOMAIN} registry`], ['', 'machine-name <string>', 'specify machine-name to pair with the token (useful for CI to avoid accidentally revoke the token)']]);
  }
