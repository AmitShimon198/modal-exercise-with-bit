...
class Move {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'move a component to a different filesystem path');
    ...
    (0, _defineProperty2().default)(this, "opts", [['c', 'component', 'move component files that are spread over multiple directories to one directory. synopsis: `move <component-id> <directory>`']]);
