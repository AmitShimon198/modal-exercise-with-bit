...
class RemoteAdd {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'add a tracked bit remote');
    (0, _defineProperty2().default)(this, "description", `add a bare-scope as a remote. supported protocols are [file, http, ssh].
...
class Remote {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'manage set of tracked bit scope(s)');
