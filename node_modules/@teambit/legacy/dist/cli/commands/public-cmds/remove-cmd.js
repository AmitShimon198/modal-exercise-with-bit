...
class Remove {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'remove component(s) from your working area, or a remote scope');
  ...
  ${(0, _constants().WILDCARD_HELP)('remove')}`);
    ...
    (0, _defineProperty2().default)(this, "opts", [['r', 'remote', 'remove a component from a remote scope'], ['t', 'track', 'keep tracking component (default = false)'], ['d', 'delete-files', 'delete local component files (authored components only. for imported components the files are always deleted)'], ['f', 'force', 'removes the component from the scope, even if used as a dependency. WARNING: components that depend on this component will corrupt'], ['s', 'silent', 'skip confirmation']]);
