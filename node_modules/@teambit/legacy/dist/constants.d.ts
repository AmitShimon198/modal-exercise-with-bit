...
declare type origins = 'IMPORTED' | 'AUTHORED' | 'NESTED';
export declare const COMPONENT_ORIGINS: {
    IMPORTED: origins;
    AUTHORED: origins;
    NESTED: origins;
};
...
export declare const LANE_REMOTE_DELIMITER = "/";
export declare const DEFAULT_LANE = "main";
...
export declare const CENTRAL_BIT_HUB_NAME = "bit.dev";
