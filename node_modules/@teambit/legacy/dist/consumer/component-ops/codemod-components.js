...
async function changeCodeFromRelativeToModulePaths(consumer, bitIds) {
  ...
  const codemodResults = componentsWithRelativeIssues.map(component => {
    const {
      files,
      warnings
    } = codemodComponent(consumer, component);
...
function codemodComponent(consumer, component) {
  ...
  component.files.forEach(file => {
    ...
    relativeInstances.forEach(relativeEntry => {
      ...
      const stringToReplace = getNameWithoutInternalPath(consumer, relativeEntry); // @todo: the "dist" should be replaced by the compiler dist-dir.
