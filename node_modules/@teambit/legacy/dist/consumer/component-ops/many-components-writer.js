...
to move all component files to a different directory, run bit remove and then bit import --path`);
  ...
  async _installPackagesIfNeeded() {
    ...
    if ((_this$consumer3 = this.consumer) !== null && _this$consumer3 !== void 0 && _this$consumer3.isLegacy) {
      ...
      var _ManyComponentsWriter, _ManyComponentsWriter2;

      await ((_ManyComponentsWriter = ManyComponentsWriter.externalInstaller) === null || _ManyComponentsWriter === void 0 ? void 0 : _ManyComponentsWriter.install()); // this compiles all components on the workspace, not only the imported ones.
