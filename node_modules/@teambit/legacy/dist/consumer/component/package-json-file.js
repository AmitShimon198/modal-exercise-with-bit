...
class PackageJsonFile {
  ...
  excludeRegistryPrefix = false, addDefaultScopeToCompId = false, // for the capsule, we want the default-scope because it gets published
  addExportProperty = false) {
    const filePath = composePath(componentDir);
    const name = (0, _componentIdToPackageName().default)(_objectSpread(_objectSpread({
      withPrefix: !excludeRegistryPrefix
    }, component), {}, {
      id: component.id
    }));
    ...
    const packageJsonObject = {
      ...
      dependencies: _objectSpread(_objectSpread(_objectSpread({}, component.packageDependencies), component.compilerPackageDependencies.dependencies), component.testerPackageDependencies.dependencies),
      devDependencies: _objectSpread(_objectSpread(_objectSpread({}, component.devPackageDependencies), component.compilerPackageDependencies.devDependencies), component.testerPackageDependencies.devDependencies),
      peerDependencies: _objectSpread(_objectSpread(_objectSpread({}, component.peerPackageDependencies), component.compilerPackageDependencies.peerDependencies), component.testerPackageDependencies.peerDependencies),
