...
class ConsumerOverrides {
  ...
  getOverrideComponentData(bitId) {
    ...
    const overrideValues = matches.map(match => (0, _clone2().default)(this.overrides[match]));
  ...
  updateOverridesIfChanged(component, areEnvsChanged) {
    ...
    if (!(0, _isEmpty2().default)(env)) overrides.env = env;
  ...
  areOverridesObjectsEqual(overridesA, overridesB) {
    ...
    return (0, _equals2().default)(overridesA || {}, overridesB || {});
  }
