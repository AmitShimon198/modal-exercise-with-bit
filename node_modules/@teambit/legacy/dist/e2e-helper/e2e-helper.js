...
function _e2eComponentJsonHelper() {
  const data = _interopRequireDefault(require("./e2e-component-json-helper"));

  _e2eComponentJsonHelper = function () {
    return data;
  };
...
class Helper {
  constructor(helperOptions) {
    ...
    (0, _defineProperty2().default)(this, "componentJson", void 0);
    ...
    this.componentJson = new (_e2eComponentJsonHelper().default)(this.scopes);
    ...
    this.scopeHelper = new (_e2eScopeHelper().default)(this.debugMode, this.scopes, this.command, this.fs, this.npm);
    this.git = new (_e2eGitHelper().default)(this.scopes, this.command, this.scopeHelper);
    this.fixtures = new (_e2eFixturesHelper().default)(this.fs, this.command, this.npm, this.scopes, this.debugMode, this.packageJson, this.scopeHelper);
    ...
    this.env = new (_e2eEnvHelper().default)(this.command, this.fs, this.scopes, this.scopeHelper, this.fixtures, this.extensions);
...
const FileStatusWithoutChalk = (0, _fromPairs2().default)(Object.keys(_mergeVersion().FileStatus).map(status => [status, (0, _utils().removeChalkCharacters)(_mergeVersion().FileStatus[status])]));
