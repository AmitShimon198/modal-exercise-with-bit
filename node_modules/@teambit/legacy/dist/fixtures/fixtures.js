...
const comp3V2 = "module.exports = () => 'comp3 v2';";
exports.comp3V2 = comp3V2;
...
const appPrintBarFooModulePath = remoteScope => `const barFoo = require('@bit/${remoteScope}.bar.foo'); console.log(barFoo());`;

exports.appPrintBarFooModulePath = appPrintBarFooModulePath;

const appPrintComp1 = remoteScope => `const comp1 = require('@${remoteScope}/comp1');\nconsole.log(comp1())`;

exports.appPrintComp1 = appPrintComp1;
...
const fooFixtureV3 = "module.exports = function foo() { return 'got foo v3'; }";
exports.fooFixtureV3 = fooFixtureV3;