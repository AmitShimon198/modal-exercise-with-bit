...
class Extension extends _baseExtension().default {
  constructor(extensionProps) {
    ...
    (0, _defineProperty2().default)(this, "api", _objectSpread({
      ...
      triggerHook: (hookName, args) => {
        if (!(0, _contains2().default)(hookName, this.newHooks)) {
  ...
  static async load(props) {
    ...
    const baseExtensionProps = await super.load(props); // const extensionProps: ExtensionProps = ((await super.load(props): BaseExtensionProps): ExtensionProps);
  ...
  registerHookActionsOnHooksManager() {
    ...
    (0, _forEachObjIndexed2().default)(registerAction, this.registeredHooksActions);
  }
...
const _createIsolatedEnv = async (scopePath, dirPath) => {
...
const _loadScope = async scopePath => {
