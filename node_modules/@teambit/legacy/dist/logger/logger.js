...
exports.default = exports.createExtensionLogger = exports.printWarning = void 0;
...
const logLevel = getLogLevel(); // eslint-disable-next-line @typescript-eslint/no-unused-vars
...
class BitLogger {
  ...
  async exitAfterFlush(code = 0, commandName) {
...
function getLogLevel() {
  ...
  const levelsStr = LEVELS.join(', '); // eslint-disable-next-line no-console
