...
class FlattenedDependenciesGetter {
  ...
  createGraphs(components) {
    this.dependenciesGraph = (0, _componentsGraph().buildComponentsGraphCombined)(components); // uncomment to see the graph nicely. very helpful for debugging
  ...
  async importExternalDependenciesInBulk() {
    ...
    this.versionDependencies = await scopeComponentsImporter.importMany(_bitId().BitIds.fromArray(bitIds), true, true);
  }
