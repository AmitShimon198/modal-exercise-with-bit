...
class ModelComponentMerger {
  constructor(existingComponent, incomingComponent, isImport, isIncomingFromOrigin, // import: incoming from original scope. export: component belong to current scope
