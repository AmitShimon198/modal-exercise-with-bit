...
async function tagModelComponent({
  ...
  const allComponentsToTag = [...componentsToTag, ...autoTagComponentsFiltered]; // check for each one of the components whether it is using an old version
...
async function addLogToComponents(components, autoTagComps, persist, message) {
  ...
  const getLog = component => {
    ...
    return {
      ...
      message: (nextVersion === null || nextVersion === void 0 ? void 0 : nextVersion.message) || message,
