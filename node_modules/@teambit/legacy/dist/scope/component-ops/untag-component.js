 ...
 */
async function removeLocalVersion(scope, id, version, // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
force = false) {
...
as a result, newer versions have this version as part of their history`);
  ...
  const allVersionsObjects = await Promise.all(localVersions.map(localVer => component.loadVersion(localVer, scope.objects)));
...
async function removeLocalVersionsForAllComponents(consumer, version, force = false) {
...
async function removeLocalVersionsForComponentsMatchedByWildcard(consumer, version, force = false, idWithWildcard) {
...
async function removeLocalVersionsForMultipleComponents(componentsToUntag, version, // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
force, scope) {
