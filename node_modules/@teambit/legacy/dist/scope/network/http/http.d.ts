...
export declare class Http implements Network {
    ...
    constructor(graphClient: GraphQLClient, _token: string | undefined | null, url: string, scopeName: string, proxyConfig?: ProxyConfig | undefined, agent?: Agent, localScopeName?: string | undefined);
    ...
    deprecateMany(ids: string[]): Promise<Record<string, any>[]>;
    undeprecateMany(ids: string[]): Promise<Record<string, any>[]>;
