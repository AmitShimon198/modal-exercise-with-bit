...
export default class SSH implements Network {
    ...
    errorHandler(code: number, err: string): GeneralError | import("../../exceptions").ComponentNotFound | import("../../exceptions").MergeConflictOnRemote | import("../exceptions").OldClientVersion | import("../exceptions").PermissionDenied | RemoteScopeNotFound | import("../exceptions").UnexpectedNetworkError | import("../exceptions/export-another-owner-private").default | import("../../../error/custom-error").default | import("../../exceptions/action-not-found").default | import("../../exceptions/client-id-in-use").default | import("../../exceptions/server-is-busy").default;
