...
function parse(buffer) {
  ...
  const [type, hash] = headers.split(_constants().SPACE_DELIMITER); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
...
path: ${err.path}`);
  ...
  static parseObject(fileContents) {
    return (0, _utils().inflate)(fileContents).then(buffer => parse(buffer));
