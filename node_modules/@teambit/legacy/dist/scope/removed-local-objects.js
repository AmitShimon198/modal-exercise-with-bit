...
class RemovedLocalObjects extends _removedComponents().default {
  constructor(removedComponentIds, missingComponents, modifiedComponents, removedDependencies, dependentBits, removedFromLane) {
    super({
      removedComponentIds,
      missingComponents,
      removedDependencies,
    ...
    (0, _defineProperty2().default)(this, "modifiedComponents", void 0);
