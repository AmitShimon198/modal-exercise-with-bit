...
async function getLastModifiedDirTimestampMs(rootDir) {
  const allDirs = await (0, _globby().default)(rootDir, {
    onlyDirectories: true // ignore: ['**/node_modules/**'], // need to think about it more. sometimes we do want to invalidate cache upon node_modules changes inside component dir
