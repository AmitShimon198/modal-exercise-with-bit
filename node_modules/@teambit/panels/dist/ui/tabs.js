...
exports.Tab = Tab;
exports.TabPanel = exports.TabContainer = void 0;
...
function _clickable() {
  const data = require("@teambit/legacy/dist/to-eject/css-components/clickable");
...
function Tab(props) {
  return (
    ...
    _react().default.createElement(_reactTabs().Tab, (0, _extends2().default)({}, props, {
      className: (0, _classnames().default)(props.className, _clickable().clickable, _tabsModule().default.tab),
