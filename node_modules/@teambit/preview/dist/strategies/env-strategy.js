...
class EnvBundlingStrategy {
  ...
  async computePaths(outputPath, defs, context) {
    ...
    const moduleMapsPromise = defs.map(async previewDef => {
      ...
      const link = this.preview.writeLink(previewDef.prefix, paths, previewDef.renderTemplatePath ? await previewDef.renderTemplatePath(context) : undefined, outputPath);
