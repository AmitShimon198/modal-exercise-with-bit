...
class PubsubUI {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "pub", (topic, event, {
      ...
      this.emitEvent(topic, event); // opt-in to forward to iframe, as we would not want 'private' messages automatically passing to iframe
  ...
  static async provider([uiUI]) {
    ...
    const reactContext = (0, _pubsubContext().createProvider)({
