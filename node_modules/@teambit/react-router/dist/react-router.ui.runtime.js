...
class ReactRouterUI {
  ...
  routeChangeListener) {
    ...
    (0, _defineProperty2().default)(this, "navigateTo", (path, action) => {
      ...
      if (typeof action !== 'string') {
        this.legacyNavigateTo(path, action);
        return;
      }
    ...
    (0, _defineProperty2().default)(this, "legacyNavigateTo", (path, state) => {
      var _this$routerHistory3;

      (_this$routerHistory3 = this.routerHistory) === null || _this$routerHistory3 === void 0 ? void 0 : _this$routerHistory3.push(path, state);
    });
  }
  /**
  ...
  renderRoutes(routes, options = {}) {
    ...
    }, /*#__PURE__*/_react().default.createElement(_routeContext().RootRoute, {
