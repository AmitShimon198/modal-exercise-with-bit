...
function CompositionsApp({
  ...
  const reactContext = previewContext.get(_react2().ReactAspect.id);
  const providers = (reactContext === null || reactContext === void 0 ? void 0 : reactContext.providers) || [];
  ...
  }, /*#__PURE__*/_react().default.createElement("style", null, hideScrollbars), /*#__PURE__*/_react().default.createElement(_reactUi2().LoaderFallback, {
    Target: Composition,
    DefaultComponent: _designUiPages().StandaloneNotFoundPage
  })));
}
