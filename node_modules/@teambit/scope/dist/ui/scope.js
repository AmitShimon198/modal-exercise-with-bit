...
function Scope({
  ...
  if (!scope) {
    return /*#__PURE__*/_react().default.createElement(_fullLoader().FullLoader, null);
  }
  ...
  return /*#__PURE__*/_react().default.createElement(_scopeUiHooks().ScopeProvider, {
    ...
    exact: true,
    path: "/"
  }, /*#__PURE__*/_react().default.createElement(_scopeOverview().ScopeOverview, {
    badgeSlot: badgeSlot,
