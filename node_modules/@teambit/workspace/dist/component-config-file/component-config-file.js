...
class ComponentConfigFile {
  constructor(componentId, aspects, propagate = false, options = {
  ...
  static async load(componentDir, aspectListFactory, outsideDefaultScope) {
    ...
    return new ComponentConfigFile(componentId, aspects, !!parsed.propagate, {
      indent,
      newLine
    }, parsed.defaultScope);
  }
  ...
  async write(componentDir, options = {}) {
