...
function _workspaceComponentsDrawer() {
  const data = require("./ui/workspace-components-drawer");

  _workspaceComponentsDrawer = function () {
    return data;
  };
...
class WorkspaceUI {
   ...
   * sidebar link slot
   */
  sidebarItemSlot, commandBarUI, reactRouterUI) {
  ...
  uiRoot() {
    this.sidebar.registerDrawer(new (_workspaceComponentsDrawer().WorkspaceComponentsDrawer)(this.sidebarSlot));
  ...
  static async provider([ui, componentUi, sidebar, componentTree, commandBarUI, reactRouterUI, graphUI], config, [routeSlot, menuSlot, menuItemSlot, sidebarSlot, sidebarItemSlot]) {
    ...
    const workspaceUI = new WorkspaceUI(routeSlot, componentUi, menuSlot, menuItemSlot, sidebar, sidebarSlot, sidebarItemSlot, commandBarUI, reactRouterUI);
...
(0, _defineProperty2().default)(WorkspaceUI, "slots", [_harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType()]);
