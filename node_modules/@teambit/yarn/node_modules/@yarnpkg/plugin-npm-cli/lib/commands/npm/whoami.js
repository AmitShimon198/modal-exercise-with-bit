...
class NpmWhoamiCommand extends cli_1.BaseCommand {
    ...
    async execute() {
        ...
        if (this.scope && this.publish)
            ...
            registry = plugin_npm_1.npmConfigUtils.getPublishRegistry((await cli_1.openWorkspace(configuration, this.context.cwd)).manifest, { configuration });
        else
        ...
        const report = await core_2.StreamReport.start({
            ...
            try {
                ...
                if (((_a = err.response) === null || _a === void 0 ? void 0 : _a.statusCode) === 401 || ((_b = err.response) === null || _b === void 0 ? void 0 : _b.statusCode) === 403) {
