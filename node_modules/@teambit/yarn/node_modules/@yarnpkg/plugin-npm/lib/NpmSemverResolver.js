...
class NpmSemverResolver {
    ...
    async resolve(locator, opts) {
        ...
        if (typeof manifest.raw.deprecated === `string`)
            opts.report.reportWarningOnce(core_1.MessageName.DEPRECATED_PACKAGE, `${core_4.structUtils.prettyLocator(opts.project.configuration, locator)} is deprecated: ${manifest.raw.deprecated}`);
        return {
            ...locator,
            version,
            languageName: `node`,
