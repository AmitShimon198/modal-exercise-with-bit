...
const pnpUtils = (0, tslib_1.__importStar)(require("./pnpUtils"));
...
class PnpInstaller {
    ...
    async finalizeInstallWithPnp(pnpSettings) {
        ...
        if (this.opts.project.configuration.get(`pnpEnableInlining`)) {
            ...
            await fslib_1.xfs.changeFilePromise(pnpPath.cjs, loaderFile, { automaticNewlines: true });
            await fslib_1.xfs.chmodPromise(pnpPath.cjs, 0o755);
